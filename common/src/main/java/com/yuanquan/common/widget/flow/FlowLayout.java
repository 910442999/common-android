...
public class FlowLayout extends ViewGroup {
    ...
    private int MAX_LINE = DEFAULT_FOLD_MAX_LINES;//从0开始计数
    ...
    public FlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        MAX_LINE = a.getInt(R.styleable.FlowLayout_flow_fold_max_lines, DEFAULT_FOLD_MAX_LINES);
    ...
    public void setFoldMaxLines(int mFoldMaxLines) {
        this.MAX_LINE = mFoldMaxLines;
    }
