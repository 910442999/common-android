...
public abstract class FlowAdapter<T> {
    ...
    public void setOnFoldClickListener(OnFoldClickListener listener) {
        this.onFoldClickListener = listener;
    }
    ...
    public void setFold(boolean fold) {
        if (this.onFoldClickListener != null) {
            this.onFoldClickListener.setFold(fold);
        }
    }
