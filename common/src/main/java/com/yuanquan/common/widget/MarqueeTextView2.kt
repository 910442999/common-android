 ...
 */
open class MarqueeTextView2 @JvmOverloads constructor(
    context: Context?,
    ...
    private fun initAttrs(attrs: AttributeSet?) {
        val a = context.obtainStyledAttributes(attrs, R.styleable.MarqueeTextView2)
        textColor = a.getColor(R.styleable.MarqueeTextView2_android_textColor, textColor)
        isResetLocation = a.getBoolean(R.styleable.MarqueeTextView2_marqueeResetLocation, true)
        speed = a.getFloat(R.styleable.MarqueeTextView2_marqueeSpeed, 1f)
        textSize = a.getDimension(R.styleable.MarqueeTextView2_android_textSize, 12f)
        textItemDistance = a.getDimension(R.styleable.MarqueeTextView2_marqueeItemDistance, 50f)
        startLocationDistance = a.getFloat(
            R.styleable.MarqueeTextView2_marqueeStartLocationDistance,
            0f
        )
        repeat = a.getInt(R.styleable.MarqueeTextView2_marqueeRepeat, REPEAT_SINGLE_LOOP)
        text = a.getText(R.styleable.MarqueeTextView2_android_text)?.toString() ?: ""
        a.recycle()
    }
     ...
     */
    private class MyHandler(view: MarqueeTextView2) : Handler(Looper.getMainLooper()) {
