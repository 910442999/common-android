 ...
 */
class MySelectTextHelper(builder: Builder) {
    ...
    class Builder(val mTextView: TextView) {
        ...
        fun build(): MySelectTextHelper {
            return MySelectTextHelper(this)
        }
    ...
    private inner class OperateWindow(context: Context?) {
        ...
        init {
            val contentView = LayoutInflater.from(context)
                .inflate(R.layout.pop_operate, null)
    ...
    private inner class CursorHandle(var isLeft: Boolean) : View(mContext) {
        ...
        override fun onTouchEvent(event: MotionEvent): Boolean {
            when (event.action) {
                ...
                MotionEvent.ACTION_MOVE -> {
                    ...
                    //如果游标按下后,不准,可根据实际情况修改 对应的值
                    update(
                        rawX + mAdjustX - mWidth - mPadding * 3 - mTextViewMarginStart,
        ...
        fun show(x: Int, y: Int) {
            ...
            Log.e(
                "TAG",
                "showCursorHandle: X :" + x + " Y :" + y + "  offset :" + offset + "  extraX :" + extraX + "  extraY :" + extraY
            )
