...
import com.yuanquan.common.adapter.DragAndSwipeAdapter
import com.yuanquan.common.utils.ToastUtils
import com.yuanquan.common.utils.vibrate

class DefaultDragAndSwipeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_default_drag_and_swipe)
        ...
        mAdapter.setOnItemClickListener { adapter, view, position ->
            ToastUtils.show(this, "点击了：$position")
        }
    }
